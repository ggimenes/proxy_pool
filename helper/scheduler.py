...
def runScheduler():
    ...
    intervalFetch = conf.intervalFetch
    intervalCheck = conf.intervalCheck 
    
    scheduler.add_job(__runProxyFetch, 'interval', seconds=intervalFetch, id="proxy_fetch", name="proxy采集")
    scheduler.add_job(__runProxyCheck, 'interval', seconds=intervalCheck, id="proxy_check", name="proxy检查")
    executors = {
